...
namespace LumenAPI.Identity.Routing;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("api/logout", async Task<Ok> ([FromServices] IServiceProvider sp) =>
        {
            var signInManager = sp.GetRequiredService<SignInManager<TUser>>();
            await signInManager.SignOutAsync();
            return TypedResults.Ok();
        })
        .WithSummary("Additional custom endpoint that logs out current user (when cookie-based authentication).");
        ...
        routeGroup.MapGet("api/confirmEmail", async Task<Results<ContentHttpResult, UnauthorizedHttpResult>>
        ...
        routeGroup.MapPost("api/resendConfirmationEmail", async Task<Ok>
        ...
        var accountGroup = routeGroup.MapGroup("api/manage").RequireAuthorization();
